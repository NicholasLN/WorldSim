...
use super::UniqueDivision;

pub struct Community {
    name: String,
    // This is the name of the community.
    division: Option<UniqueDivision>,
    // This is the administrative division that the community is a part of.
    centerpoint: Point<f64>,
    // This is the centerpoint of the community.
    boundaries: Vec<Point<f64>>,
    // This is the list of points that make up the boundaries of the community.
    population: u32,                 // This is the population of the community.
}

impl Community {
    pub fn new(name: String, division: Option<UniqueDivision>, centerpoint: Point<f64>, boundaries: Vec<Point<f64>>) -> Community {
        Community {
            name,
            division,
            centerpoint,
    ...
    pub fn get_division(&self) -> &Option<UniqueDivision> { &self.division }
